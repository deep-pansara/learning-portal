    ...
    <>
   {
    isLoading ? (
      ...
      <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
        <h2 className="dark:text-white text-[#000000c7] text-[25px] px-4 w-full 1000px:text-[50px] font-[800] font-Josefin 1000px:leading-[75px] 1500px:w-[60%] 1100px:w-[78%]">
          {data?.layout?.banner?.title || "Improve Your Learning Experience With Us"}
        </h2>
        <br />
