...
import { addAnswer, addQuestion, addReplyReview, addReview, editCourse, getAllCourses, getAllCoursesAdmin, getCourseByUser, getSignleCourse, uploadCourse } from "../controllers/course.controller";
